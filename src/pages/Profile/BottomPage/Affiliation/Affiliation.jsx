...
const SVGWallet = () => (
  <svg width="32" height="32" viewBox="0 0 67 69" fill="none" xmlns="http://www.w3.org/2000/svg" style={{verticalAlign:'middle'}}>
    <g clipPath="url(#clip0_447_2098)">
      <path d="M5.29102 29.0563C6.02252 29.0563 6.58789 29.6279 6.58789 30.4V60.9713L6.69434 61.0455C6.99039 61.2538 7.47743 61.4662 8.13477 61.6813C8.79813 61.8983 9.65455 62.1245 10.7041 62.3522C12.8038 62.8077 15.689 63.2731 19.3711 63.692C26.7365 64.5299 37.3041 65.1813 51.1816 65.1813H51.6973C53.8533 65.1813 55.5566 63.4154 55.5566 61.2125V52.9938H51.9551C48.2845 52.9938 45.2441 49.8722 45.2441 46.0719C45.2441 42.2716 48.2845 39.15 51.9551 39.15H62.0098C62.7413 39.15 63.3066 39.7216 63.3066 40.4938V51.65C63.3066 52.4222 62.7413 52.9938 62.0098 52.9938H58.1504V61.2125C58.1504 64.9065 55.2647 67.8688 51.6973 67.8688H51.1816C38.864 67.8688 27.2725 67.3376 18.5713 66.3297C11.7413 65.5331 8.07632 64.633 6.12402 63.7281C5.15105 63.2772 4.62513 62.8344 4.33984 62.4235C4.05907 62.0188 3.99414 61.62 3.99414 61.2125V30.4C3.99414 29.6279 4.55951 29.0563 5.29102 29.0563ZM51.9551 41.8375C49.696 41.8375 47.8379 43.7628 47.8379 46.0719C47.8379 48.381 49.696 50.3063 51.9551 50.3063H60.7129V41.8375H51.9551ZM22.3066 1.43127H51.6973C55.2647 1.43127 58.1504 4.39351 58.1504 8.08752V19.775C58.1504 20.5472 57.585 21.1188 56.8535 21.1188C56.122 21.1188 55.5566 20.5472 55.5566 19.775V8.08752C55.5566 5.88467 53.8533 4.11877 51.6973 4.11877H49.3848V18.7125C49.3848 19.4847 48.8194 20.0563 48.0879 20.0563C47.3564 20.0563 46.791 19.4847 46.791 18.7125V4.11877H40.1035V18.7125C40.1035 19.4847 39.5382 20.0563 38.8066 20.0563C38.0751 20.0563 37.5098 19.4847 37.5098 18.7125V4.11877H22.3066C20.1507 4.11877 18.4473 5.88467 18.4473 8.08752V16.2164C18.4471 16.9884 17.8818 17.5602 17.1504 17.5602C16.419 17.5602 15.8537 16.9884 15.8535 16.2164V8.08752C15.8535 4.39351 18.7392 1.43127 22.3066 1.43127Z" fill="white" stroke="#02070D" strokeWidth="0.5"/>
    </g>
    <rect x="1.15039" y="1.15002" width="65" height="67" stroke="#02070D"/>
    <defs>
      <clipPath id="clip0_447_2098">
        <rect x="0.650391" y="0.650024" width="66" height="68" fill="white"/>
      </clipPath>
    </defs>
  </svg>
);
